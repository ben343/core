...
public class AuthorTest {
    ...
    private static final String SEARCH_BOOK_BT_TITLE = " 7";
...
//
    ...
    private static void addBook() {
        ...
        Book book = new Book(title, description, prince, count);
    ...
    private static void printCommands() {
        ...
        System.out.println("Please input" + SEARCH_BOOK_BT_TITLE + " for SEARCH_BOOK_BT_TITLE");
